...
export const cards: {
    ...
    links: {
        ...
        Card(
            ...
            <>
                <p>
                    The essence of inspiration, the finishing touch, the detail that transforms the ordinary into something special.
                    <br />
                    A Pitada doesn't just offer help, it is a help.
                    <br />
                    It's the very <strong>Pitada</strong> of creativity your kitchen was missing.
                    <br />
                    What are you looking for in the app? A <strong>Pitada</strong>. What do you save from Reels?
                    <br />
                    A Pitada. The app's function is to capture and deliver these culinary inspiration techniques quickly and impactfully.
                </p>
            ...
            [{ name: "App Store", url: "https://apps.apple.com/ph/app/pitada/id6747889796" }]
        ),
